import "./index.scss";
// 导入登录页面的logo图片
import headerbanner from "@/assets/bilihome-assets/img/header-banner.webp";
import logo from '@/assets/bilihome-assets/img/logo.png'
import cardimage from '@/assets/bilihome-assets/img/card-image.avif'
import carouselimage from "@/assets/bilihome-assets/img/carousel-image.avif"
const Bilibili = () => {
  return (
    <div>
      {/* 头部 */}
      <div className="large-header">
        {/* 头部-上导航 */}
        <div className="bili-top-nav">
          {/* 头部-上导航-左侧导航栏 */}
          <ul className="left-entry-ul">
            {/* 注意点：1.emmet:li*8>a>span 2.鼠标中间 3.shift+option+鼠标*/}
            <li>              
          ...
          {/* 头部-上导航-右侧导航 */}
          <ul className="right-entry-ul">
            <li className="header-avator">
              <a href="/">
                <span>登录</span>
              </a>
            </li>
        ...
        {/* 头部-中banner */}
        <div className="bili-middle-banner">
          {/* 注意点: jsx {导入图片名称} */}
          <img className="image" src={headerbanner} alt="" />
          <div className="bilibili-logo">
              <a href="/">
        ...
        {/* 头部-下频道 */}
        <div className="bili-bottom-channel">
          {/* 头部-下频道-左边 */}
          <div className="channel-items_left">
            {/* a*3>div+span */}
            <a href="/">
              <div className="channel-items_avator icon_dynamic">
            ...
            <a href="/">
              <div className="channel-items_avator icon_channel">
          ...
          <div className="channel-items_middle">
            <a href="/">番剧</a>
            <a href="/">国创</a>
            <a href="/">综艺</a>
            <a href="/">动画</a>
          ...
          {/* 头部-下频道-右边 */}
          <div className="channel-items_right">
            <a href="/">
      ...
      <div className="main">
        ...
        <div className="recommended-container">
          {/* 轮播 */}
          <div className="recommended-carousel-area">
          ...
          <div className="recommended-card">
            ...
            <cardImage>
              {/* 图片 */}
              <img className="card-image" src={cardimage} alt=""></img>       
              {/* 视频说明 */}
